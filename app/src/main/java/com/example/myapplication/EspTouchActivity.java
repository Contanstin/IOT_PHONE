...
public class EspTouchActivity extends EspTouchActivityAbs implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wifiOption=findViewById(R.id.wifiOption);
        wifiOption.setText(R.string.wifiOption);

        psw_hide = findViewById(R.id.psw_hide);
        psw_hide.setImageResource(R.mipmap.psw_hide);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.psw_hide:
                if (hide) {
                    psw_hide.setImageResource(R.mipmap.psw_nohide);
